...
names = ['əʊ', 'aʊ', 'uː', 'eɪ', 'aɪ', 'ɜː', 'iː', 'ɔː', 'ə', 'ɛ', 'ɪ', 'ɔɪ', 'ɑː', 'ɒ', 'p', 'n', 'l']
...
ax2 = ax1.twinx()
ax2.plot(np.array(verbs) / nouns, color='green', alpha=0.8)
ax2.plot(np.array([85 / 124] * len(nouns)), 'k--', alpha=0.8)
ax2.set_ylabel('Ratio (verbs/nouns)')
ax2.set_ybound(0.0, 3.0)
